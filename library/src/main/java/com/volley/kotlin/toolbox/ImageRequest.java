...
import com.volley.kotlin.DefaultRetryPolicy;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            return Response.Companion.error(new ParseError(response));
        } else {
            return Response.Companion.success(bitmap, HttpHeaderParser.parseCacheHeaders(response));
        }
    }
